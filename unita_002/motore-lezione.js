    ...
    return `
        <div class="container-auto">
            ...
            <div id="autovalutazione-main-container">
                <p style="color: #999; font-style: italic;">⏳ Caricamento dati...</p>
            </div>
        </div>`;
}
...
function generaSchedaEssereAvereCloze(ConfigLezione, isDocente) {
    ...
    ` : ''}
    <div class="cloze-testo">
        <p style="margin: 0;">${testoFormattato}</p>
...
if (n.fase2.audio) {
    ...
    if (ex.spaziDaCompletare.includes(idxReale)) {
        ...
        // ---- PANNELLO DOCENTE (DENTRO LO STESSO BLOCCO) ----
    if (isDocente && ex.spaziDaCompletare) {
        html += `
        <div style="margin-top: 20px; padding: 15px; background: #fff3cd; border-radius: 8px; border: 1px solid #ffeeba;">
